  ...
  return (
    <div className="bg-[#0B1F3A] text-white overflow-x-hidden">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                <div className="relative">
                  <button
                    onClick={handleTrack}
                    className={`px-8 py-4 rounded-xl font-bold text-lg flex items-center gap-2 transition-all duration-200 ${
                      isAuthenticated
                        ? "bg-gradient-to-r from-[#1E88E5] to-[#00C2FF] text-white shadow-[0_0_30px_rgba(0,194,255,0.35)] hover:shadow-[0_0_50px_rgba(0,194,255,0.55)] hover:-translate-y-0.5"
                        : "bg-gradient-to-r from-[#1E88E5]/60 to-[#00C2FF]/60 text-white/80 cursor-pointer"
                    }`}
                  >
                    <MapPin className="w-5 h-5" /> Track Shipment
                  </button>
                  {showLoginTip && (
                    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 whitespace-nowrap px-3 py-1.5 rounded-lg bg-[#0d2545] border border-[#00C2FF]/40 text-[#00C2FF] text-xs font-semibold shadow-lg z-50">
                      Please login first
                    </div>
                  )}
                </div>
                <Link href={isAuthenticated ? "/customer/quotes" : "/contact"}>
      ...
      <section className="py-24 bg-[#0d2040]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-[#00C2FF] text-xs uppercase tracking-widest">What We Offer</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div key={label}
                ...
                className="rounded-2xl border border-white/8 bg-white/[0.03] p-4 cursor-default transition-all duration-300 hover:border-[#00C2FF]/30"
                style={{ animation: "card-glow 4s ease-in-out infinite" }}
              >
                <div className="flex justify-center mb-3">
                  <motion.div
                    className="w-12 h-12 rounded-xl bg-[#1E88E5]/15 border border-[#1E88E5]/25 flex items-center justify-center"
      ...
      <section className="py-24 bg-[#0d2040]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            <span className="text-[#00C2FF] text-xs uppercase tracking-widest">Real Feedback</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map(({ name, role, text, rating }, i) => (
              <motion.div
                ...
                whileHover={{ y: -8, boxShadow: "0 20px 40px rgba(0,194,255,0.12)" }}
                className="rounded-2xl border border-white/8 bg-white/[0.03] p-8 transition-all duration-300 hover:border-[#00C2FF]/25"
              >
      ...
      <section className="py-24 relative overflow-hidden" style={{ background: "linear-gradient(135deg,#0d2545 0%,#0B1F3A 50%,#061830 100%)" }}>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <span className="inline-block px-4 py-1.5 rounded-full border border-[#00C2FF]/30 bg-[#00C2FF]/10 text-[#00C2FF] text-xs uppercase tracking-widest mb-6">Let's Get Moving</span>
