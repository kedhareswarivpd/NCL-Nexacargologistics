...
const STATS = [
  ...
  { label: "Active Branches", value: "12",    delta: "3 countries",       Icon: GitBranch,   color: "text-secondary bg-secondary/10" },
  { label: "Active Shipments",value: "348",   delta: "+12 today",         Icon: Package,     color: "text-green-400 bg-green-400/10" },
  { label: "System Health",   value: "99.8%", delta: "Uptime this month", Icon: Activity,    color: "text-on-tertiary-container bg-on-tertiary-container/10" },
];
