...
export default function FinanceSettingsPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <SettingsCard icon={DollarSign} title="Finance Preferences">
        <div>
          <label htmlFor="field-currency-4" className="text-xs uppercase tracking-widest text-on-surface-variant">Default Currency</label>
          <select id="field-currency-4" className="mt-1 w-full px-3 py-2 rounded-lg bg-surface-container border border-white/10 text-sm text-on-surface focus:outline-none focus:border-tertiary/50">
            <option>INR (₹)</option>
            <option>USD ($)</option>
            <option>EUR (€)</option>
            <option>GBP (£)</option>
        ...
        <div>
          <label htmlFor="field-fiscal-year-5" className="text-xs uppercase tracking-widest text-on-surface-variant">Fiscal Year Start</label>
          <select id="field-fiscal-year-5" className="mt-1 w-full px-3 py-2 rounded-lg bg-surface-container border border-white/10 text-sm text-on-surface focus:outline-none focus:border-tertiary/50">
