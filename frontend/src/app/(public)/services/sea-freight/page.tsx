...
import { ArrowLeft, Ship, Anchor, Globe, FileText, Truck, Shield, CheckCircle2 } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#0a1628] text-white overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden" style={{ height: 440 }}>
        ...
        {[
          ...
          <div key={`item-{i}`} className="absolute" style={{ top: g.top, opacity: 0.45, animation: `cloud-drift-sea ${g.dur} linear infinite`, animationDelay: g.delay }}>
