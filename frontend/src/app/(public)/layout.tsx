  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background">
      <div className="pointer-events-none absolute inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-[18%] right-[-6%] h-72 w-72 rounded-full bg-secondary/10 blur-3xl animate-float" style={{ animationDelay: "0.4s" }} />
        <div className="absolute bottom-[-8%] left-[30%] h-80 w-80 rounded-full bg-tertiary/10 blur-3xl animate-float" style={{ animationDelay: "0.4s" }} />
