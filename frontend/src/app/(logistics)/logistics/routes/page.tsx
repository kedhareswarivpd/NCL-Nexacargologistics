    ...
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2 shrink-0">
          ...
          <button type="button" onClick={() => setShowForm(!showForm)} className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-tertiary/20 text-tertiary text-xs font-semibold hover:bg-tertiary/30 transition-colors"><Plus className="h-4 w-4" /> Add Route</button>
        </div>
      </div>
          ...
          filtered.map((r) => (
            <Card key={r.id} className="p-5 space-y-3 group hover:border-white/10 transition-colors">
              ...
              <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-all">
                <button type="button" onClick={() => openEdit(r)} className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 text-tertiary text-xs hover:bg-tertiary/10 transition-colors">
                  <Edit className="h-3.5 w-3.5" /> Edit
                </button>
                <button type="button" onClick={() => handleDelete(r.id)} className="flex items-center gap-1 px-3 py-1.5 rounded-lg bg-white/5 text-error text-xs hover:bg-error/10 transition-all">
