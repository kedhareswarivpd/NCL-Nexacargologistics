  ...
  return (
    <aside className="flex h-full flex-col p-4 bg-surface-container-low/20 backdrop-blur-md border-r border-white/5 shadow-xl w-[280px]">
      ...
      <div className="mt-auto flex flex-col gap-1 pt-6 border-t border-white/5">
        ...
        <button type="button" onClick={handleLogout} className="w-full flex items-center gap-4 text-on-surface-variant p-3 hover:bg-white/5 hover:text-error transition-colors font-label-caps text-xs uppercase tracking-widest rounded-lg">
