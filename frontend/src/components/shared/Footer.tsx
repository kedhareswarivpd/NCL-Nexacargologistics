    ...
    <footer className="w-full bg-surface-container-lowest border-t border-white/5 relative overflow-hidden">
      ...
      <div className="py-12 px-6 flex flex-col sm:flex-row justify-between gap-8 max-w-7xl mx-auto w-full relative z-10">
        <div className="w-full sm:w-[280px] shrink-0">
          ...
          <div className="flex items-start gap-2 text-xs text-on-surface-variant/70 mb-6">
        ...
        <div className="w-full sm:w-auto">
          <h5 className="text-sm font-bold text-white uppercase tracking-widest mb-6 mt-0">Company</h5>
          <ul className="space-y-4">
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/privacy-policy">Privacy Policy</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/terms-of-service">Terms of Service</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/careers">Careers</Link></li>
          </ul>
        </div>
        <div className="w-full sm:w-auto">
          <h5 className="text-sm font-bold text-white uppercase tracking-widest mb-6 mt-0">Network</h5>
          <ul className="space-y-4">
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/global-offices">Global Offices</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/warehouse-network">Warehouse Network</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/customs-hubs">Customs Hubs</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/partners">Partners</Link></li>
          </ul>
        </div>
        <div className="w-full sm:w-auto">
          <h5 className="text-sm font-bold text-white uppercase tracking-widest mb-6 mt-0">Support</h5>
          <ul className="space-y-4">
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/contact">Contact</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/contact">Help Center</Link></li>
            <li><Link className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200" href="/customer/track">Track Status</Link></li>
            <li><a href="/customer/quotes" onClick={handleRequestQuote} className="inline-block text-sm text-on-surface-variant hover:text-[#00C2FF] hover:translate-x-1 transition-all duration-200 cursor-pointer">Request Quote</a></li>
          </ul>
        </div>
      </div>
