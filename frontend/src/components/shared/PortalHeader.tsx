...
const GRID_LINKS: Record<string, { icon: React.ElementType; label: string; href: string; color: string }[]> = {
  admin: [
    ...
    { icon: Truck,           label: "Logistics",    href: "/admin/logistics",  color: "text-orange-400 bg-orange-400/10" },
    { icon: Warehouse,       label: "Warehouse",    href: "/admin/warehouse",  color: "text-blue-400 bg-blue-400/10" },
    { icon: Navigation,      label: "Driver",       href: "/admin/driver",     color: "text-yellow-400 bg-yellow-400/10" },
    { icon: TrendingUp,      label: "Finance",      href: "/admin/finance",    color: "text-pink-400 bg-pink-400/10" },
  ],
  customer: [
