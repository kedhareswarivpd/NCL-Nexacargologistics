...
# Logistics, admin, customer (simulation), and drivers (self-assign) can access dispatch
dispatch_guard = require_roles(UserRole.LOGISTICS, UserRole.ADMIN, UserRole.CUSTOMER, UserRole.DRIVER)
